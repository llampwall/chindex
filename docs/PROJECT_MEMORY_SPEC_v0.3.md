# Project Memory System - Spec v0.3
...
## [IGNORE] Migration from 5-file System
...
| `bugs.md` | `DECISIONS.md` | Each bug fix = decision entry (use bug format) |
| `worklog.md` | `DECISIONS.md` | Significant entries only (apply logging threshold) |

---

## Open Questions - [IGNORE] THESE ARE NO LONGER RELEVANT
...
5. **Validation:** How do we know the memory files are accurate/useful? (Consider: periodic human spot-check, or a "confidence score" in the footer)
...
- v0.2 review feedback (decision threshold, dedupe, coverage anchor, failure modes)
